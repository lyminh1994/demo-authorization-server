package dev.hobie.authorizationservice.repository.impl;

import dev.hobie.authorizationservice.dto.RsaKeyPair;
import dev.hobie.authorizationservice.keys.RsaPrivateKeyConverter;
import dev.hobie.authorizationservice.keys.RsaPublicKeyConverter;
...
public class JdbcRsaKeyPairRepository implements RsaKeyPairRepository {
  ...
  public List<RsaKeyPair> findKeyPairs() {
    return this.jdbc.query(
        "select * from rsa_key_pairs order by created desc", this.keyPairRowMapper);
  }
