...
[source,java]
-----
include::resource-service/src/main/java/dev/hobie/resourceservice/Customer.java[]
-----
...
[source,java]
-----
include::resource-service/src/main/java/dev/hobie/resourceservice/CustomerRepository.java[]
-----
...
[source,java]
-----
include::resource-service/src/main/java/dev/hobie/resourceservice/CustomerHttpController.java[]
-----
...
[source,java]
-----
include::resource-service/src/main/java/dev/hobie/resourceservice/MeHttpController.java[]
-----
...
[source,java]
-----
include::resource-service/src/main/java/dev/hobie/resourceservice/EmailController.java[]
-----
...
[source,java]
-----
include::resource-service/src/main/java/dev/hobie/resourceservice/EmailRequestsIntegrationFlowConfiguration.java[]
-----
...
[source,java]
----
include::resource-service/src/main/java/dev/hobie/resourceservice/ClientCredentialsClient.java[]
----
