...
[source,java]
-----
include::resource-service/src/main/java/dev/hobie/resourceservice/model/Customer.java[]
-----
...
[source,java]
-----
include::resource-service/src/main/java/dev/hobie/resourceservice/repository/CustomerRepository.java[]
-----
...
[source,java]
-----
include::resource-service/src/main/java/dev/hobie/resourceservice/controller/CustomerController.java[]
-----
...
[source,java]
-----
include::resource-service/src/main/java/dev/hobie/resourceservice/controller/MeController.java[]
-----
...
[source,java]
-----
include::resource-service/src/main/java/dev/hobie/resourceservice/controller/EmailController.java[]
-----
...
[source,java]
-----
include::resource-service/src/main/java/dev/hobie/resourceservice/config/EmailRequestsIntegrationFlowConfig.java[]
-----
...
[source,java]
----
include::resource-service/src/main/java/dev/hobie/resourceservice/util/ClientCredentialsUtils.java[]
----
