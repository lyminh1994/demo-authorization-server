...
[source,java]
-----
include::gateway-service/src/main/java/dev/hobie/gatewayservice/SecurityConfiguration.java[]
-----
...
[source,java]
-----
include::gateway-service/src/main/java/dev/hobie/gatewayservice/GatewayConfiguration.java[]
-----
